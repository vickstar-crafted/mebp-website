...
<section className="border-b border-gray-200 bg-gradient-to-br from-white via-green-50 to-white">
  <div className="mx-auto max-w-7xl px-6 py-20 text-center">
    ...
    <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
      Whether you represent a school or work as an educational bookseller or
      agent, we are available to help you find the right books and learning
      resources for your students and customers.
    </p>
  </div>
</section>
